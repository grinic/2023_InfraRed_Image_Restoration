...
if __name__ =='__main__':
    ...
    quantification_folders = [
        ...
        os.path.join('restored_with_model_4dpf_1fish_patches32x128x128_2layers','tif_restored'),
    ...
    full_image_files = [
        ...
        glob.glob(os.path.join(infolder,'*ch02.tif'))[0],
        glob.glob(os.path.join(infolder,'restored_with_model_4dpf_1fish_patches32x128x128_2layers','restoredFull_csbdeep','*.tif'))[0],
        glob.glob(os.path.join(infolder,'restored_with_N2V','restoredFull','*.tif'))[0],
    ...
    for i in range(len(quantification_folders)):
        ...
        for j in range(len(infolders)):
            df = pd.read_csv(os.path.join(infolders[j], quantification_folders[i], 'quantification.csv'))
    ...
    fig_red.savefig('fish_visualize_badIR2_patches.pdf', dpi=900)
    fig_green.savefig('fish_visualize_goodIR2_patches.pdf', dpi=900)
